...
document.addEventListener('DOMContentLoaded', () => {
   ...
   if (headline && paragraph) {
      ...
      const textSets = [
         {
            h1: "Scalable Software<br>Engineered to Last",
            p: "We architect robust, cloud-native applications that clean up technical debt and reliably handle millions of users."
         },
         {
            h1: "Innovation Framed<br>in Clean Code",
            p: "Our engineering teams leverage cutting-edge tech stacks and agile design sprints to turn complex product roadmaps into reality."
         },
         {
            h1: "Your Digital Future<br>Fully Documented",
            p: "From secure API integrations to automated deployment pipelines, we build custom solutions that guarantee high availability."
         }
      ];
